...
def make_pipeline():
    ...
    free_cash_flows = Fundamentals_m.free_cash_flow.latest 
    basic_accounting_change_earnings_reports_mask = Fundamentals_m.basic_accounting_change_earnings_reports.latest
    net_income_income_statement_mask = Fundamentals_m.net_income_income_statement.latest 
    roa_mask = Fundamentals_m.roa.latest 
    cash_conversion_cycle_mask = Fundamentals_m.cash_conversion_cycle.latest 
    adjusted_geography_segment_data_mask = Fundamentals_m.adjusted_geography_segment_data.latest 
    ...
    free_cash_flows = free_cash_flows.winsorize(min_percentile=0.1, max_percentile=0.90)
    basic_accounting_change_earnings_reports_mask = basic_accounting_change_earnings_reports_mask.winsorize(min_percentile=0.1, max_percentile=0.90)
    net_income_income_statement_mask = net_income_income_statement_mask.winsorize(min_percentile=0.1, max_percentile=0.90)
    roa_mask = roa_mask.winsorize(min_percentile=0.1, max_percentile=0.90)
    cash_conversion_cycle_mask = cash_conversion_cycle_mask.winsorize(min_percentile=0.1, max_percentile=0.90)
    adjusted_geography_segment_data_mask = adjusted_geography_segment_data_mask.winsorize(min_percentile=0.1, max_percentile=0.90)
    ...
    combined_factor = (
        (free_cash_flows.zscore() + 
        5*basic_accounting_change_earnings_reports_mask.zscore() + 
        10*net_income_income_statement_mask.zscore()+
        35*roa_mask.zscore()+
        20*cash_conversion_cycle_mask.zscore()+
        20*adjusted_geography_segment_data_mask.zscore())/100
    )
